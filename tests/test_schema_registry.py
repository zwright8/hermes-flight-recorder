...
class SchemaRegistryTests(unittest.TestCase):
    def test_catalog_loads_public_artifact_contracts(self):
        ...
        expected_names = {
            ...
            "tau3_source_split",
            "tau3_teacher_generation_run",
            "tau3_training_exposure",
            "tau3_training_source",
            "tau3_training_bundle",
            "tau3_training_mixture",
            "task_completion",
            "trace",
            "trace_observability",
            "trajectory_v2",
