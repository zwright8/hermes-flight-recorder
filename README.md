...
| Data | Turn validated runs into redacted SFT/DPO/reward/review datasets and registry handoffs after rejection-sampling admission. | `rejection-sampling-gate`, `flightrecorder goal3-handoff`, `export-rl`, `export-compare-rl`, `export-review`, `apply-review` |
...
| Loop | Bind rollout plan/receipt, review, trainer, serving, eval, improvement, promotion, and next-iteration receipts into fail-closed plans and ledgers. | `agentic-loop plan`, `agentic-loop ledger`, `validate --agentic-loop-ledger` |
