...
class ValidationTests(unittest.TestCase):
    ...
    def test_strict_validate_warns_on_absolute_lineage_replay_sources(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(any(Path(record["path"]).is_absolute() for record in lineage["outputs"] if record["name"] == "scorecard"))
            ...
            self.assertIn("artifact_lineage.outputs.scorecard.path is absolute", warnings)
