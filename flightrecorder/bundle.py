    ...
    if missing_harness_pairs:
        actions.append(
            _action(
                ...
                "critical",
                "harness_handoff",
                "Attach matched harness_manifest.json and harness_result.json artifacts before downstream Eval or Governance consumes this handoff.",
                {
    ...
    if failed_harness_pairs or invalid_harness_pairs:
        actions.append(
            _action(
                ...
                "critical",
                "harness_handoff",
                "Fix failed, schema-invalid, or inconsistent harness run lineage before publishing this evidence bundle.",
                {
