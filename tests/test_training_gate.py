...
class TrainingGateTests(unittest.TestCase):
    def test_gate_export_accepts_demo_policy(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(result["metrics"]["trainer_view_source_fingerprint_coverage"]["rows"], 12)
            self.assertEqual(result["metrics"]["trainer_view_source_fingerprint_coverage"]["fully_verified"], 12)
