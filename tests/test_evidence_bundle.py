...
class EvidenceBundleTests(unittest.TestCase):
    def test_evidence_bundle_summarizes_ready_handoff(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(repair_action["evidence"]["item_count"], 11)
            self.assertEqual(repair_action["evidence"]["critical_item_count"], 11)
            self.assertEqual(repair_action["evidence"]["scenario_count"], 4)
            self.assertEqual(repair_action["evidence"]["priority_counts"], {"critical": 11})
            ...
            self.assertEqual(curriculum_action["evidence"]["curriculum_failure_mode_count"], 11)
            ...
            self.assertEqual(bundle["decision"]["key_metrics"]["repair_queue"]["item_count"], 11)
            ...
            self.assertEqual(bundle["metrics"]["repair_queue"]["critical_item_count"], 11)
            self.assertEqual(bundle["metrics"]["training_export"]["episode_count"], 6)
            self.assertEqual(bundle["metrics"]["training_export"]["curriculum_failure_mode_count"], 11)
