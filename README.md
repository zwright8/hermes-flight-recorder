...
| Data | Turn validated runs into redacted SFT/DPO/reward/review datasets and registry handoffs after rejection-sampling and curation admission. Rejection-sampling refs must replay from the gate directory or they are redacted and blocked. | `rejection-sampling-gate`, `dataset-curation-receipt`, `flightrecorder goal3-handoff`, `export-rl`, `export-compare-rl`, `export-review`, `apply-review` |
