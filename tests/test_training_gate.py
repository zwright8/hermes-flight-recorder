...
class TrainingGateTests(unittest.TestCase):
    def test_gate_export_accepts_demo_policy(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(result["metrics"]["trainer_view_source_fingerprint_coverage"]["rows"], 13)
            self.assertEqual(result["metrics"]["trainer_view_source_fingerprint_coverage"]["fully_verified"], 13)
            ...
            self.assertEqual(result["metrics"]["task_completion"]["check_pass_rate"], 0.5238)
            ...
            self.assertEqual(result["policy"]["effective"]["min_task_completion_check_pass_rate"], 0.5238)
