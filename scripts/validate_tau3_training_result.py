#!/usr/bin/env python3
"""Validate a private Tau-3 MLX training execution bundle."""
...
from flightrecorder.tau3_execution_validation import validate_tau3_training_result_bundle  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = validate_tau3_training_result_bundle(args.bundle, strict=args.strict)
